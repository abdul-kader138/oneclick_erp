...
function defaultCompany()
{
	...
	echo "<table class='titletext'><tr><td>Paragon Group</td></tr></table>\n";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/paragon.jpg' alt='paragon' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
